...
<div class="m-0 py-3">
    <nav class="navbar navbar-expand-lg navbar-light bg-primary fixed-top">
        <div class="container-fluid">
          <h1 class="navbar-brand text-white fw-bold ">Add New Vendor <i class="bi bi-buildings"></i></h1>
...
<div class="container py-5 mt-5 d-flex justify-content-center border " style="background-color : #f2f2f2">
    <div class="container">
                ...
                <form action="../php/add_vendors.php" method="post">
                    <div class="container w-50">
                            <div class="container">
                                <label for="vendorname" class="form-label text-primary fw-bold">Vendor Name</label>
                                <input type="text" class="form-control form-control-sm" name="vendorname" placeholder="Jane..." >
                            </div>
                            <div class="container">
                                <label for="vendorcontact" class="form-label text-primary fw-bold">Vendor contact</label>
                                <input type="number" class="form-control form-control-sm" name="vendornumber" placeholder="(011) 000 0000">
                            </div>
                            <div class="container">
                                <label for="vendoraddress" class="form-label text-primary fw-bold">Vendor Address</label>
                                <input type="text" class="form-control form-control-sm" name="vendoraddress" placeholder="Doe...">
                            </div>
