...
<div class="m-0 py-1">
    <nav class="navbar navbar-expand-lg navbar-light bg-primary fixed-top">
        <div class="container-fluid">
          <h1 class="navbar-brand text-white fw-bold ">Employees <i class="bi bi-people-fill"></i></h1>
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto">
                    <a class="btn btn-outline-light mx-3" href="../forms/add_employee_form.php">New Employee</a>
...
<div class="container py-3 m-5">
    <div class="container">
        <?php
            ...
            $sql = "SELECT e_id, e_emp_number, concat(e_firstname,' ',e_last_name) AS 'Name' FROM assets_management_db.employees;";
                        ...
                        echo '<table id="assettable" class="table table-sm table-striped border rounded border-primary ">';
                            echo "<thead class='table-primary'>";
                                echo "<tr class='text-primary'>";
                                    ...
                                    echo "<th scope='col'>Emp Number</th>";
                                    echo "<th scope='col'>Emp Names</th>";
                            ...
                            echo "</thead>";
                                echo "<tbody>";
                                    while($row = mysqli_fetch_array($result)){
                                        echo "<tr>";
                                            echo "<td>" . $row['e_id'] . "</td>";
                                            echo "<td>" . $row['e_emp_number'] . "</td>";
                                            echo "<td>" . $row['Name'] . "</td>";
                                            echo "<td>";
                                                echo"<div class ='container my-1 d-flex justify-content-start'>";
                                                    echo '<a href="../forms/update_employees.php?id='.$row['e_id'].'" class="btn btn-outline-primary w-auto btn-sm"><i class="bi bi-pencil"></i></a>';
                                                    echo '<a href="../php/employeedelete.php?id='.$row['e_id'].'" class="btn btn-outline-dark w-auto btn-sm mx-1" ><i class="bi bi-trash3-fill"></i></>';
                                                echo "</div>";
                                            echo "</td>";
                                        echo "</tr>";
                                        }
