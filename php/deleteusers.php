...
if(!empty($_GET['id'])){
    if(isset($_POST['delete']))
    {
        ...
        $sql = "DELETE FROM assets_management_db.users where id = ?";
...
<div class="signin-form">
    <form action="../php/deleteusers.php?id=<?php echo $_GET['id'];?>" method="post">
        <h4 class="text-danger">This Users Will Be Deleted Permanently. <i class=" bi bi-emoji-frown text-primary"></i></h4>
