...
<div class="m-0 ">
    <nav class="navbar navbar-expand-lg navbar-light bg-primary fixed-top">
        <div class="container-fluid">
          <h1 class="navbar-brand text-white fw-bold ">Admin <i class="bi bi-person-circle"></i></h1>
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto">
                    <a class="btn btn-outline-light mx-3" href="../Authorization/register.php">New User</a>
...
<div class="container py-3 m-5">
    <div class="container">
        <h4 class="text-primary fw-bold">Users</h4>
        <?php
            ...
            $sql = "SELECT id , username,created_at FROM assets_management_db.users;";
                                        ...
                                        echo "<tr>";
                                            ...
                                            echo "<td>";
                                                echo"<div class ='container my-1 d-flex justify-content-start'>";
                                                    echo '<a href="../php/deleteusers.php?id='.$row['id'].'" class="btn btn-outline-dark w-auto btn-sm mx-1" ><i class="bi bi-trash3-fill"></i></>';
                                                echo "</div>";
                                            echo "</td>";
                                        echo "</tr>";
                                        }
...
<div class="fixed-footer bg-primary ">
    <div id="flex-container" class="container navbar-nav bg-primary  ">
            <nav>
                <a class="text-white fw-bold m-1" href="dashboard.php">Dashboard <i class="bi bi-table"></i></a>
                <a class="text-white fw-bold m-1" href="employees.php">Employees <i class="bi bi-people-fill"></i></a>
                <a class="text-white fw-bold m-1" href="vendors.php">Vendors <i class="bi bi-buildings"></i></a>
            </nav>
    </div>        
</div>
</body>
