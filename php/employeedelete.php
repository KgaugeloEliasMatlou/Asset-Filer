...
if(!empty($_GET['id'])){
    if(isset($_POST['delete']))
    {
        ...
        $sql = "DELETE FROM assets_management_db.employees where e_id = ?";
...
<div class="signin-form">
    <form action="../php/employeedelete.php?id=<?php echo $_GET['id'];?>" method="post">
        <h4 class="text-danger">This Employee Will Be Deleted Permanently. <i class=" bi bi-emoji-frown text-primary"></i></h4>
