...
<div class="m-0 py-3">
    <nav class="navbar navbar-expand-lg navbar-light bg-primary fixed-top">
        <div class="container-fluid">
          <h1 class="navbar-brand text-white fw-bold ">Add New Employee <i class="bi bi-people-fill"></i></h1>
                ...
                <form action="../php/add_employee.php" method="post">
                    <div class="container w-50">
                            <div class="container">
                                ...
                                <input type="text" class="form-control form-control-sm" name="empnumber" placeholder="E100">
                            </div>
                            <div class="container">
                                <label for="firstname" class="form-label text-primary fw-bold">Employee First Name</label>
                                <input type="text" class="form-control form-control-sm" name="empfirstname" placeholder="Jane">
                            </div>
                            <div class="container">
                                <label for="lastname" class="form-label text-primary fw-bold">Employee Last Name</label>
                                <input type="text" class="form-control form-control-sm" name="emplastname" placeholder="Doe">
                            </div>
