...
if(!empty($_GET['id'])){
    if(isset($_POST['delete']))
    {
        ...
        $sql = "DELETE FROM assets_management_db.Assets where a_id = ?";
...
<div class="signin-form">
    <form action="../php/assetdelete.php?id=<?php echo $_GET['id'];?>" method="post">
        <h4 class="text-danger">This Asset Will Be Deleted Permanently. <i class=" bi bi-emoji-frown text-primary"></i></h4>
