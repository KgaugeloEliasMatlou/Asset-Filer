...
if(!empty($_GET['id'])){
    if(isset($_POST['delete']))
    {
        ...
        $sql = "DELETE FROM assets_management_db.site_locations where sl_id = ?";
...
<div class="signin-form">
    <form action="../php/companysitedelete.php?id=<?php echo $_GET['id'];?>" method="post">
        <h4 class="text-danger">This Company Site Will Be Deleted Permanently. <i class=" bi bi-emoji-frown text-primary"></i></h4>
